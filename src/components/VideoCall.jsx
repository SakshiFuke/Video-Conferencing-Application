...
const VideoCall = () => {
  ...
  const handleCreateRoom = async () => {
    try {
      const meetingCode = uuidv4().slice(0, 8).toUpperCase(); // Backend expects a fixed-length ID
      const hostId = 1; // Static for now, ideally get from auth context
      ...
      {joined && (
        <>
          ...
          <div id="remote-container" className="remote-videos-container">
            {/* Remote videos dynamically added */}
          </div>
